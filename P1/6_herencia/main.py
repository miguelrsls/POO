...
print(coche.getMarca(), coche.acelerar())

camioneta=Camionetas("Nissan", "Amarillo", "2025", 180, 200, 5, "Trasera", False)
print(camioneta.getMarca(), camioneta.acelerar())
